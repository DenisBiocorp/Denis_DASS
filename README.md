![Computing at the heart of biology](/image/illustration.png)

**`Master's student in Genomics and Bioinformatics | Clinical Biologist | Genomic Data Analyst`**

> *"Computing at the heart of biology"*

---

## 🧬 About Me

I am a **clinical biologist** (Bachelor's degree in Medical and Biological Analysis, hospital experience) transitioning into **genomics and bioinformatics**. My hands-on lab background taught me diagnostic rigor; my current training teaches me how to analyze genomic data using computational tools. **This portfolio showcases my skills, expertise, and areas of interest.**
...
| Domain | Tools / Skills |
|--------|----------------|
| **NGS (preprocessing)** | FASTQC, MultiQC, Trimmomatic, Fastp, kmergenie, jellyfish, Spades |
| **Genomic analysis** | PLINK (variant analysis) |
| **Scientific programming** | R(analysis & visualization), Python|
...
| Project | Bioinformatics Goal | Stack |Link|
|--------|--------------------------|-------|
| **Sequencing data preprocessing** | Quality control (FASTQC), Data merging with MultiQC , Trimming (Fastp), Kmer analysis | Bash |[click here for more information](https://denisbiocorp.github.io/NGS-pre-treatment/)| 
